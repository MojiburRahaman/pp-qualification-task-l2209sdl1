...
<body>
    ...
    <div class="container" id="container">
        <div class="form-container sign-up-container">
            <form action="{{ route('RegisterPost') }}" method="post" id="vendorSignup">
                ...
                <select class="select" name="account_type_id" id="">
                ...
                <input type="password" name="pin" placeholder="5 digit Pin" />
...
container.classList.remove("right-panel-active");
    ...
    error:function (response) {
          ...
          $('.type_err').text(response.responseJSON.errors.account_type_id);
