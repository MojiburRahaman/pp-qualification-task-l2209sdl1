...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            @can('Personal_Account',auth('web')->user())
            <li class="nav-item  {{ (url()->current() == route('AddMoney')) ? 'active' : ''  }}">
                <a class="nav-link" href="{{ route('AddMoney') }}">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Add Money</span></a>
            </li>
            <li class="nav-item  {{ (url()->current() == route('SendMoneyView')) ? 'active' : ''  }}">
                <a class="nav-link" href="{{ route('SendMoneyView') }}">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
            ...
            @endcan
            @can('Agent_AAccount', auth('web')->user())
            <li class="nav-item  {{ (url()->current() == route('CashInView')) ? 'active' : ''  }}">
                <a class="nav-link" href="{{ route('CashInView') }}">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Cash In</span></a>
            </li>
            @endcan
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{ auth('web')->user()->name
                                    }}
                                    ({{ auth('web')->user()->account->name }})</span>
                                <img class="img-profile rounded-circle"
                                    src="{{ Avatar::create(auth('web')->user()->name)->toBase64() }}">
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Account : {{ auth('web')->user()->account->name }}
                                </a>
